...
\restrict xP1YAMH8cMdqYFh2VtNHMoeCP8DCxEK4OSDaX8joSQRZBuYyG36i7AmZB3GsN7I
...
ALTER TABLE IF EXISTS ONLY public."_CategoryToCourse" DROP CONSTRAINT IF EXISTS "_CategoryToCourse_B_fkey";
ALTER TABLE IF EXISTS ONLY public."_CategoryToCourse" DROP CONSTRAINT IF EXISTS "_CategoryToCourse_A_fkey";
...
ALTER TABLE IF EXISTS ONLY public."OrderItem" DROP CONSTRAINT IF EXISTS "OrderItem_courseId_fkey";
DROP INDEX IF EXISTS public."_CategoryToCourse_B_index";
DROP INDEX IF EXISTS public."User_email_key";
DROP INDEX IF EXISTS public."Order_paymentId_key";
DROP INDEX IF EXISTS public."Coupon_code_key";
ALTER TABLE IF EXISTS ONLY public."_CategoryToCourse" DROP CONSTRAINT IF EXISTS "_CategoryToCourse_AB_pkey";
...
ALTER TABLE IF EXISTS ONLY public."ContentSettings" DROP CONSTRAINT IF EXISTS "ContentSettings_pkey";
ALTER TABLE IF EXISTS ONLY public."Category" DROP CONSTRAINT IF EXISTS "Category_pkey";
DROP TABLE IF EXISTS public."_CategoryToCourse";
...
DROP TABLE IF EXISTS public."ContentSettings";
...
INSERT INTO public."Category" (id, name, "orderIndex") VALUES ('99ff1092-3560-45c9-a56b-8de38fd4b684', 'CANLI DERSLER', 1);
INSERT INTO public."Category" (id, name, "orderIndex") VALUES ('6ec0ab5c-6e86-49c6-af5b-382dbf5aa919', 'VİDEO DERSLER', 2);
INSERT INTO public."Category" (id, name, "orderIndex") VALUES ('21d2024e-99ef-41f6-9ec8-359796623413', 'GENEL TEKRAR', 3);
INSERT INTO public."Category" (id, name, "orderIndex") VALUES ('640cc353-2e3e-4ede-a400-d44f7a5763f0', 'ONLINE DENEME', 4);
...
INSERT INTO public."ContentSettings" (key, value) VALUES ('faq', '[{"q":"Dersleri sonradan tekrar izleyebilir miyim?","a":"Evet, tüm canlı derslerimiz yayın bittikten hemen sonra sisteme yüklenir. Sınav gününe kadar sınırsız kez geriye dönük izleyebilirsiniz."},{"q":"Dökümanlar ve PDF kaynaklar adrese gönderiliyor mu?","a":"Eğitim paketlerimize dahil olan PDF dökümanları dijital olarak öğrenci panelinize yüklenir. Kitap veya fiziksel yayın gönderimleri ürün açıklamalarında ayrıca belirtilir."},{"q":"Ödemelerde taksit imkanı var mı?","a":"PayTR güvenli ödeme altyapımız sayesinde tüm banka ve kredi kartlarına 12 aya varan taksit seçenekleriyle ödeme yapabilirsiniz."},{"q":"Kupon kodlarını nasıl kullanırım?","a":"Kupon kodunuzu sepet çekmecesinde veya satın alma aşamasındaki kupon girişi alanına yazıp ''Uygula'' butonuna basarak sepetinize yansıtabilirsiniz."}]');
INSERT INTO public."ContentSettings" (key, value) VALUES ('achievements', '[{"name":"Merve K.","rank":"Türkiye 4.sü","year":"2025 KPSS","comment":"Hocalarımın ilgisi ve dökümanların kalitesi sayesinde bu başarıyı elde ettim."},{"name":"Selin Y.","rank":"Türkiye 12.si","year":"2025 KPSS","comment":"Canlı ders sonrasındaki soru-cevap saatleri eksiklerimi kapatmamda çok etkili oldu."},{"name":"Kadir T.","rank":"Türkiye 27.si","year":"2024 KPSS","comment":"Dil bilgisi kampları ve online deneme sınavları tam ÖSYM ayarındaydı."}]');
INSERT INTO public."ContentSettings" (key, value) VALUES ('teachers', '[{"name":"Rüstem Hoca","title":"Dil Bilgisi ve Alan Eğitimi Uzmanı","bio":"12 yıllık ÖABT tecrübesiyle, sınavda çıkan tüm dil bilgisi konularının ve alan eğitimi yöntemlerinin mimarı."},{"name":"Ömer Hoca","title":"Edebiyat ve Alan Bilgisi Uzmanı","bio":"Divan edebiyatından halk edebiyatına, ÖABT sınavının ezber bozan taktikleriyle dersleri eğlenceli kılan eğitmenimiz."},{"name":"Murat Hoca","title":"Rehberlik ve Motivasyon Danışmanı","bio":"Sınav hazırlık sürecinizde haftalık çalışma planları ve mentörlük desteğiyle her an yanınızda olan rehberimiz."}]');
INSERT INTO public."ContentSettings" (key, value) VALUES ('slider', '[{"title":"Slider Başlık 1","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/1.png"},{"title":"Slider Başlık 2","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/2.png"},{"title":"Slider Başlık 3","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/3.png"},{"title":"Slider Başlık 4","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/4.png"},{"title":"Slider Başlık 5","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/5.png"},{"title":"Slider Başlık 6","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/6.png"},{"title":"Slider Başlık 7","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/7.png"},{"title":"Slider Başlık 8","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/8.png"},{"title":"Slider Başlık 9","subtitle":"Slider açıklama metni buraya gelecek...","buttonText":"Hemen İncele","buttonLink":"#kurslar","image":"https://toa.muro.click/slider/9.png"}]');
INSERT INTO public."ContentSettings" (key, value) VALUES ('legal_settings', '{"faq":[{"q":"Dersleri sonradan tekrar izleyebilir miyim?","a":"Evet, tüm canlı derslerimiz yayın bittikten hemen sonra sisteme yüklenir. Sınav gününe kadar sınırsız kez geriye dönük izleyebilirsiniz."},{"q":"Dökümanlar ve PDF kaynaklar adrese gönderiliyor mu?","a":"Eğitim paketlerimize dahil olan PDF dökümanları dijital olarak öğrenci panelinize yüklenir. Kitap veya fiziksel yayın gönderimleri ürün açıklamalarında ayrıca belirtilir."},{"q":"Ödemelerde taksit imkanı var mı?","a":"PayTR güvenli ödeme altyapımız sayesinde tüm banka ve kredi kartlarına 12 aya varan taksit seçenekleriyle ödeme yapabilirsiniz."},{"q":"Kupon kodlarını nasıl kullanırım?","a":"Kupon kodunuzu sepet çekmecesinde veya satın alma aşamasındaki kupon girişi alanına yazıp ''Uygula'' butonuna basarak sepetinize yansıtabilirsiniz."}]}');
INSERT INTO public."ContentSettings" (key, value) VALUES ('corporate_settings', '{"teachers":[{"name":"ENES KAAN ŞAHİN","title":"DÖRT TEMEL BECERİ, DİL BİLİM","bio":"","image":"/kadromuz/enes_kaan_sahin_hd.jpg"},{"name":"ASIM KARA","title":"YENİ TÜRK EDEBİYATI, DİL BİLGİSİ","bio":"","image":"/kadromuz/asım_kara_hd.jpg"},{"name":"FATİH BEDİR","title":"DİL BİLGİSİ, DİL BİLİM","bio":"","image":"/kadromuz/fatih_bedir_hd.jpg"},{"name":"İLKER HAYAT","title":"ESKİ TÜRK EDEBİYATI, BEYİT ŞERHLERİ","bio":"","image":"/kadromuz/ilker_hayat_hd.jpg"},{"name":"ALİ ZEYBEK","title":"HALK EDEBİYATI, EDEBİYAT BİLGİ VE KURAMLARI","bio":"","image":"/kadromuz/ali_zeybek_hd.jpg"},{"name":"İSA KURTUL","title":"ÇOCUK EDEBİYATI","bio":"","image":"/kadromuz/isa_kurtul_hd.jpg"},{"name":"BÜŞRA ÖZBAĞ","title":"REHBERLİK","bio":"","image":"/kadromuz/busra_ozbag_hd.jpg"}],"achievements":[{"name":"Merve K.","rank":"Türkiye 4.sü","year":"2025 KPSS","comment":"Hocalarımın ilgisi ve dökümanların kalitesi sayesinde bu başarıyı elde ettim."},{"name":"Selin Y.","rank":"Türkiye 12.si","year":"2025 KPSS","comment":"Canlı ders sonrasındaki soru-cevap saatleri eksiklerimi kapatmamda çok etkili oldu."},{"name":"Kadir T.","rank":"Türkiye 27.si","year":"2024 KPSS","comment":"Dil bilgisi kampları ve online deneme sınavları tam ÖSYM ayarındaydı."}]}');
INSERT INTO public."ContentSettings" (key, value) VALUES ('homepage_settings', '{"slider":[{"title":"Slider Başlık 1","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/1.png"},{"title":"Slider Başlık 2","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/2.png"},{"title":"Slider Başlık 3","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/3.png"},{"title":"Slider Başlık 4","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/4.png"},{"title":"Slider Başlık 5","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/5.png"},{"title":"Slider Başlık 6","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/6.png"},{"title":"Slider Başlık 7","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/7.png"},{"title":"Slider Başlık 8","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/8.png"},{"title":"Slider Başlık 9","subtitle":"Açıklama...","buttonText":"İncele","buttonLink":"#","image":"/slider/9.png"}]}');
...
INSERT INTO public."Coupon" (id, code, "discountType", "discountValue", "courseId", "isActive", "expiryDate", "createdAt", "influencerEmail", "influencerName", "startDate", "usageCount", "usageLimit") VALUES ('34dc51dc-aa76-4141-bdad-36096c1f9bb0', 'TEST20', 'PERCENTAGE', 20, NULL, true, NULL, '2026-07-27 05:27:43.882', NULL, NULL, NULL, 0, NULL);
...
INSERT INTO public."User" (id, email, "passwordHash", name, surname, phone, role, "createdAt") VALUES ('4e14bfed-d446-407c-8a32-3080e5e04157', 'admin@turkceoabtdeyiz.com', '$2b$10$UjQSkIBWMqc.VYBgljWmZOEaJu4s.9/XdqyAWV15pVpoBAAgY.KGG', 'Rüstem', 'Hoca', NULL, 'ADMIN', '2026-07-27 03:58:50.632');
INSERT INTO public."User" (id, email, "passwordHash", name, surname, phone, role, "createdAt") VALUES ('5b5f06cc-5a25-44af-8135-ba131274a004', 'ogrenci@email.com', 'test.toa.2026', 'Ahmet', 'Yılmaz', NULL, 'STUDENT', '2026-07-27 03:58:50.696');
...
INSERT INTO public."_CategoryToCourse" ("A", "B") VALUES ('99ff1092-3560-45c9-a56b-8de38fd4b684', '1bfa3615-7f26-4f34-a9d4-0922aebbc692');
INSERT INTO public."_CategoryToCourse" ("A", "B") VALUES ('6ec0ab5c-6e86-49c6-af5b-382dbf5aa919', '668d3200-9148-4045-aaee-ff0890c55f4c');
INSERT INTO public."_CategoryToCourse" ("A", "B") VALUES ('6ec0ab5c-6e86-49c6-af5b-382dbf5aa919', 'ca85e9ef-4d18-4935-84ac-d5ac67d6b424');
INSERT INTO public."_CategoryToCourse" ("A", "B") VALUES ('99ff1092-3560-45c9-a56b-8de38fd4b684', 'fa970da4-d5b0-4147-93bb-17c79e258c06');
...
\unrestrict xP1YAMH8cMdqYFh2VtNHMoeCP8DCxEK4OSDaX8joSQRZBuYyG36i7AmZB3GsN7I
