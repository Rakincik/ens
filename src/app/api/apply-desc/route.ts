...
<h4 style="margin-top:24px; color: var(--color-primary);">AGS DERS PAKETİ İÇERİĞİ:</h4>
...
<h5 style="margin-top:24px; color: var(--color-primary);">Öğretmen Kadrosu</h5>
...
export async function GET() {
  try {
    const result = await prisma.course.updateMany({
      where: { 
        title: {
          contains: "2027 ERKEN KAYIT CANLI TÜRKÇE ÖABT"
        }
      },
